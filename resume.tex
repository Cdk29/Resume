...
The circular RNA design script is write in Python, is executed in command line, and take as argument, not genes names, but the microRNAs' names that the sponge should decoy from theirs original target. This names are obtained in the previous section of the workflow, using Cytoscape.\\
