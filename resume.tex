...
As stated in the introduction, some recent works has demonstrated that the repression of many miRNA targets is frequently associated
with their destabilization and a change in the abundance of some of validated or predicted miRNA targets \cite{cancer}. 

Studies in which microRNAs levels were experimentally altered, revealed marked changes in the abundance of validated or predicted miRNA targets \cite{cancer}. Since microRNAs levels are altered in many diseases, including cancer \cite{cancer}

In a more general way, the KEGGs pathways incode in 
