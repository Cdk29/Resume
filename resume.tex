...
More directly, relying on the expertise of the user is another approach. The user can have - through western blot experiments for example -, genes of interest which are not necessary differentially expressed, but for which the translation of the messenger RNA is inhibited.\\
