...
\section{MicroRNAs}
MicroRNAs are 20-24 nt RNA molecules, which can form a complex with AGO family proteins members, to exert a post-transcriptional repression \cite{network, site, Urich, cancer}.\\
This repression is exert by a inhibition of the translation's initiation, and 
eventually, by a messenger RNA destabilization \cite{site, cancer}. \\ 
The repression is mediated by the binding of the complex microRNA-Ago protein to the target messenger RNA, the complementarity between the microRNA sequence and the messenger RNA beeing the vector of recognition of the messenger RNA target.\\
\begin{figure}[H]
	\centering
...
Formed by backsplincing\cite{?}, the circular RNA are a class of long non coding RNA.\\
While the exact nature of their function remains elusive \cite{?, mir7, sponge}, it has been proved that one of them is to "sponge" the microRNAs\cite{mir7,sponge}. \\
...
\begin{figure}[H]
	...
	\caption{The structure of the first iteration of the workflow. The retrieving of the genes composing the Melanoma KEGG pathways using a SQL query is th first step and the main characteristic of this iteration}
\end{figure}
...
\begin{figure}[H]
	\centering
	{\includegraphics[width=0.70\textwidth]{Final_Workflow.png}}
