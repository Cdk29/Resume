...
Since the feature selection and the differential analysis inside the KEGG pathways

The use of the KEGG pathways inside the triplexdatabase was not concluent


The differential expression analysis performed on the curated data , and 
...

It seems more favorable to rely on the user's particular expertise

The  form retain for the worflow rely on the user to provide the genes of interest and in this chapter (see below)

To retake the exemple of Hepatocellular Carcinoma, which is develop in the introduction and in this chapter (selow below, cirMOT1 in hepatocellular carcinoma), no all the genes differentially expressed in the hepato carcinoma cancer \cite{example}, and a sponge which have target would note be as effective as a one sponging specificaly the microRNAs targeting the mRNA of p21.
